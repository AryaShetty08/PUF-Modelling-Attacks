...
def trainP(challenges, responses):
    ...
    with open("models/Perceptron/1/params.txt", "a") as file:
...
def testP(challenges, responses, model):
    ...
    plt.savefig(f'models/Perceptron/1/{model_name.lower().replace(" ", "_")}_confidence_distribution.png')
    print(f"Confidence curves saved to models/Perceptron/1/{model_name.lower().replace(' ', '_')}_confidence_distribution.png")
...
def plot_train(model_name, train_losses, val_losses, val_accuracies):
    ...
    plt.tight_layout()
    plt.savefig(f'models/Perceptron/1/{model_name.lower().replace(" ", "_")}_training_curves.png')
    print(f"Training curves saved to models/Perceptron/1/{model_name.lower().replace(' ', '_')}_training_curves.png")
...
if __name__ == "__main__":
    # reset txt file
    with open("models/Perceptron/1/params.txt", "w") as file:
        file.write("Start\n")
    ...
    # Save the model
    torch.save(model.state_dict(), f"models/Perceptron/1/perceptron_model.pth")
