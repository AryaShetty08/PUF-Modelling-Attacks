...
def trainLR(challenges, responses):
    ...
    plt.savefig(f'models/LR/5/{model_name.lower().replace(" ", "_")}_training_curves.png')
    print(f"Training curves saved to models/LR/5/{model_name.lower().replace(' ', '_')}_training_curves.png")
...
def testLR(challenges, responses, model):
    ...
    if len(high_conf_predictions) > 0:
        ...
        with open("models/LR/5/params.txt", "a") as file:
    ...
    model_name = f"LR"
    plt.savefig(f'models/LR/5/{model_name.lower().replace(" ", "_")}_confidence_distribution.png')
    print(f"Confidence curves saved to models/LR/5/{model_name.lower().replace(' ', '_')}_confidence_distribution.png")
...
if __name__ == "__main__":
    # reset txt file
    with open("models/LR/5/params.txt", "w") as file:
        file.write("Start\n")
    ...
    joblib.dump(model, f"models/LR/5/lr_model.joblib")
